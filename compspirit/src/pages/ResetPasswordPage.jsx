...
const PwInput = ({ 
  ...
  const inputRef = useRef(null) // ← AJOUT IMPORTANT

  // Calcul des bordures basé sur la correspondance
          ...
          {!token ? (
            <div style={{ 
              ...
              <Link to="/login" style={{ 
                ...
                alignItems:'center', 
                gap:9,
                background: 'linear-gradient(135deg,#D90B2E,#CF0A2C)', 
                color:'white',
                padding:'12px 28px', 
                fontSize:11, 
                fontWeight:800, 
                ...
                {done ? (
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom:24 }}>
                      ...
                      <PwInput 
                        value={confPw} 
                        onChange={e => { setConfPw(e.target.value); setError(null) }}
                        show={showCnf} 
                        setShow={setShowCnf}
